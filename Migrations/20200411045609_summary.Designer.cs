...
namespace EzilineTask.Migrations
{
    ...
    [Migration("20200411045609_summary")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EzilineApp.Api.CoreApplication.Models.summary", b =>
                {
                    b.Property<int>("id")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("EzilineApp.Api.CoreApplication.Models.summary", b =>
                {
                    b.HasOne("EzilineApp.Api.CoreApplication.Models.website", "website")
                        .WithOne("summary")
                        .HasForeignKey("EzilineApp.Api.CoreApplication.Models.summary", "webid")
                        .OnDelete(DeleteBehavior.Cascade);
                });
